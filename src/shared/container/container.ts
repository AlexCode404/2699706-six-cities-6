...
import { JwtTokenService } from '../libs/token/jwt-token.service.js';
import { PrivateRouteMiddleware } from '../http/middleware/private-route.middleware.js';
import { ParseTokenMiddleware } from '../http/middleware/parse-token.middleware.js';
...
container.bind<ParseTokenMiddleware>(Component.ParseTokenMiddleware).to(ParseTokenMiddleware).inSingletonScope();
